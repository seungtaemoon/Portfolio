...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = "postgres://muyuwbzfzqydsk:b4b30616491c4ec0b18ef28659081cd2e5f855a73b227582983c57db3df47799@ec2-34-200-106-49.compute-1.amazonaws.com:5432/d5i5iv69ve7d00"
...
# DATABASES - {
#     "POSTGRESQL":{
#         "DEFAULT": "postgres://muyuwbzfzqydsk:b4b30616491c4ec0b18ef28659081cd2e5f855a73b227582983c57db3df47799@ec2-34-200-106-49.compute-1.amazonaws.com:5432/d5i5iv69ve7d00"
#     }
# }
...
# user = api.get_user(screen_name='suwon_wt')
# tweet = api.user_timeline(screen_name='suwon_wt')[0]
# user_2 = api.get_user(screen_name='BTS_twt')
# tweet_2 = api.user_timeline(screen_name='BTS_twt')[0]
# print(user.id, user_2.id)
# print(user.name, user_2.name)
# print(user.followers_count, user_2.followers_count)
# print(tweet.text, tweet_2.text)

# vecs = en.encode(texts=[tweet.text])
# vecs2 = en.encode(texts=[tweet_2.text])

# new_user = User(user_id = user.id, username=user.screen_name, full_name=user.name, followers_count=user.followers_count, location=user.location)
# db.session.add(new_user)

# db.session.flush()

# new_user_2 = User(user_id = user_2.id, username=user_2.screen_name, full_name=user_2.name, followers_count=user_2.followers_count, location=user_2.location)
# db.session.add(new_user_2)

# db.session.flush()

# new_tweet = Tweet(username = user.screen_name, text = tweet.text, embedding= vecs)
# db.session.add(new_tweet)

# db.session.flush()

# new_tweet_2 = Tweet(username = user_2.screen_name, text = tweet_2.text, embedding= vecs2)
# db.session.add(new_tweet_2)
